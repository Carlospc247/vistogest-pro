    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nif_bi', models.CharField(max_length=14, unique=True, validators=[django.core.validators.RegexValidator(message='Formato inválido. O NIF deve conter 10 dígitos ou o BI no formato 008693558LA042.', regex='^(\\d{10}|\\d{9}[A-Z]{2}\\d{3})$')], verbose_name='NIF / BI')),
