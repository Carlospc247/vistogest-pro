    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='assinatura_fiscal', to='empresas.empresa')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('tipo_documento', models.CharField(choices=[('FT', 'Fatura Crédito'), ('RC', 'Recibo'), ('FR', 'Fatura-Recibo'), ('FP', 'Fatura Proforma'), ('NC', 'Nota de Crédito'), ('ND', 'Nota de Débito'), ('DT', 'Documento de Transporte'), ('VD', 'Venda a Dinheiro'), ('TV', 'Talão de Venda'), ('TD', 'Talão de Devolução')], max_length=3, verbose_name='Tipo de Documento')),
                ...
                ('tipo_cliente', models.CharField(choices=[('particular', 'Particular'), ('isento', 'Isento de IVA'), ('nao_residente', 'Não Residente'), ('regime_especial', 'Regime Especial')], default='particular', max_length=20, verbose_name='Tipo de Cliente')),
                ...
                ('empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documentos_fiscais', to='empresas.empresa')),
