    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.ForeignKey(help_text='Empresa responsável pelo agendamento.', on_delete=django.db.models.deletion.CASCADE, related_name='agendamentos', to='empresas.empresa')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ativo', models.BooleanField(default=True)),
                ('empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='templates_relatorios', to='empresas.empresa')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorias', models.ManyToManyField(blank=True, to='empresas.categoria')),
                ('empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='empresas.empresa')),
                ('funcionarios', models.ManyToManyField(blank=True, to='funcionarios.funcionario')),
                ('lojas', models.ManyToManyField(blank=True, to='empresas.loja')),
