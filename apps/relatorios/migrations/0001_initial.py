    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_inicio', models.DateField()),
                ('data_fim', models.DateField()),
                ('dimensao', models.CharField(choices=[('produto', 'Por Produto'), ('categoria', 'Por Categoria'), ('cliente', 'Por Cliente'), ('vendedor', 'Por Vendedor'), ('forma_pagamento', 'Por Forma de Pagamento'), ('periodo', 'Por Período')], max_length=20)),
