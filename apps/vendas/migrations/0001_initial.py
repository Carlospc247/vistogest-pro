    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['vendedor', 'status'], name='vendas_meta_vendedo_839196_idx'), models.Index(fields=['ano', 'mes'], name='vendas_meta_ano_f3d218_idx'), models.Index(fields=['data_inicio', 'data_fim'], name='vendas_meta_data_in_6e2071_idx'), models.Index(fields=['codigo_meta'], name='vendas_meta_codigo__11c3e0_idx')],
                'unique_together': {('vendedor', 'tipo_periodo', 'mes', 'ano'), ('vendedor', 'tipo_periodo', 'semestre', 'ano'), ('vendedor', 'tipo_periodo', 'trimestre', 'ano')},
            },
        ),
    ]
