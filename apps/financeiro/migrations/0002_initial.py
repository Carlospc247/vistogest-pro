...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='contapai',
            index=models.Index(fields=['status'], name='financeiro__status_9dc45c_idx'),
        ),
        migrations.AddIndex(
            model_name='contapagar',
        ...
        migrations.AddIndex(
            model_name='movimentacaofinanceira',
            index=models.Index(fields=['data_movimentacao'], name='financeiro__data_mo_c4312f_idx'),
        ),
        migrations.AddIndex(
            model_name='movimentacaofinanceira',
        ...
        migrations.AddIndex(
            model_name='impostotributo',
            index=models.Index(fields=['regime_tributario'], name='financeiro__regime__a9856e_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='impostotributo',
            unique_together={('codigo_receita_agt', 'ano_referencia', 'mes_referencia')},
        ),
        migrations.AddIndex(
            model_name='movimentocaixa',
            index=models.Index(fields=['data_movimento'], name='financeiro__data_mo_cea548_idx'),
        ),
        migrations.AddIndex(
            model_name='movimentocaixa',
