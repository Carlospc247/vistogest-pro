    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(choices=[('diretoria', 'Diretoria'), ('gerencia', 'Gerência'), ('coordenacao', 'Coordenação'), ('supervisao', 'Supervisão'), ('operacional', 'Operacional'), ('tecnico', 'Técnico'), ('administrativo', 'Administrativo'), ('vendas', 'Vendas'), ('direcao_tecnica', 'Direção Técnica'), ('estagiario', 'Estagiário'), ('rh', 'Recursos Humanos'), ('financeiro', 'Contabilidade'), ('outros', 'Outros')], default='operacional', max_length=20)),
                ...
                ('permissions', models.ManyToManyField(blank=True, to='auth.permission', verbose_name='Permissões do Django')),
            ],
            options={
                'verbose_name': 'Cargo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recebe_copia_faturamento_email', models.BooleanField(default=False, help_text='Diretores e Gerentes recebem uma cópia de cada documento fiscal emitido.', verbose_name='Receber Cópia de Faturamento?')),
                ('recebe_copia_faturamento_whatsapp', models.BooleanField(default=False, verbose_name='Receber via WhatsApp?')),
                ...
                ('usuario', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='funcionario',
            index=models.Index(fields=['nome_completo'], name='funcionario_nome_co_2eb46c_idx'),
        ),
        migrations.AddIndex(
            model_name='funcionario',
            index=models.Index(fields=['ativo'], name='funcionario_ativo_20b6c6_idx'),
        ),
        migrations.AddIndex(
            model_name='funcionario',
